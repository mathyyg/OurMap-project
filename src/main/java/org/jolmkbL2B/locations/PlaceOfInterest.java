...
/** Ce constructeur doit être utilisé pour importer un marqueur depuis les bases de donnees importées (y compris la ville, zipCode et addresse*/
    public PlaceOfInterest(String placeType, double latitude, double longitude, String id, String name, String city, String zipCode,String address)
    ...
    public PlaceOfInterest(GeoPosition coord, String placeType, String name)
    {
        this.location=coord;
        this.placeType = placeType;
